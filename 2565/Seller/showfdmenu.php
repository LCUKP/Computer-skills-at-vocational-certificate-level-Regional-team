  ...
  <div class="container">
    <div class="row">
        <?php while ($row=mysqli_fetch_array($result)){ ?>
          ...
          <img src="fdimg/<?php echo $row['fdImage'];?>" class="card-img-top">
          <div class="card-body">
          ...
          <?php echo  "<a href='editmenu.php?FoodID=$row[0]' class='btn btn-warning'>แก้ไขข้อมูล</a> "; ?>
  </div>
</div>

<?php } ?><a href="seller-page.php" class="btn btn-success m-1">กลับหน้าแรก</a>
</div></div>
